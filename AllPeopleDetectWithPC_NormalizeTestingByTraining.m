...
Test_NormalScore = EigVec'*( (Test.Normal-repmat(mean_Training, 1, size(Test.Normal,2) ) ) ./ repmat(std_Training, 1, size(Test.Normal,2) ) );
Test_AbnormalScore = EigVec'*( (Test.Abnormal-repmat(mean_Training, 1, size(Test.Abnormal,2) ))  ./ repmat(std_Training, 1, size(Test.Abnormal,2) ) );
