...
%Mask = [Mask [1, 1 0 0, 1 0 0, zeros(1,6)]];
Mask = [Mask [0, 0 0 0, 0 0 0, zeros(1,6)]];
...
test_normal_rslt = vec2ind( sim(Trained_PNN, Test.Normal) );
test_abnormal_rslt = vec2ind( sim(Trained_PNN, Test.Abnormal) );
